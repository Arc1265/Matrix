//+------------------------------------------------------------------+
//| FIX3_1_MatrixRegressionChannel_TREND_REGIME.mq5                   |
//| FIX3_1: режимный движок поверх квадратичного МНК-ядра FIX2.      |
//| Правило нумерации: небольшие правки = FIX3_1, FIX3_2, ...,       |
//| префикс версии в начале имени файла.                             |
//|                                                                  |
...
#define MRC3_VERSION      "FIX3_1_TREND_REGIME"
