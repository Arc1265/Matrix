//+------------------------------------------------------------------+
//| FIX3_2_MatrixRegressionChannel_TREND_REGIME.mq5                   |
//| FIX3_2: режимный движок поверх квадратичного МНК-ядра FIX2.      |
...
#define MRC3_VERSION      "FIX3_2_TREND_REGIME"
...
input double InpReversalS           = 2.5;   // |S| быстрого окна для разворота
input double InpReversalERF         = 0.25;  // Минимальный |ER| быстрого окна для разворота
